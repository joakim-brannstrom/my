...
struct Simulator {
    ...
    // True if the PID should execute.
    bool updatePid;
    ...
    void tick(string TsUnit = "nsecs", PidT)(ref PidT pid) {
        currTime += simTick;
        updatePid = false;
        ...
        wakeupTime = currTime + period + (cast(long)(pid.output + gain)).dur!TsUnit;
